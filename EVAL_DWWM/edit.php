...
<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" id="title" value="<?=$old_title?>" required>
        </div>
        <div class="form-group">
            <label for="description">Description:</label>
            <textarea name="description" id="description" rows="4" class="form-control" ><?=$old_description?></textarea>
        </div>
        <div class="form-group">
            <label for="date">Date:</label>
            <input value="<?=$old_date?>" type="date" class="form-control" name="date" id="date" max="<?= date('y-m-d');?>" required>
        </div>
